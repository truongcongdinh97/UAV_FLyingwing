    ...
    def _define_component_positions(self) -> Dict[str, Dict]:
        ...
        components = {
            ...
            'esp32_cam': {
                ...
                'z': 0.03,
                'weight': 0.010,
                'description': 'ESP32-CAM với SD card (Hộp đen - tháo rời được)'
            },
            # Lưu ý: GY-9250 và HC-SR04 thuộc hệ thống Hộp đen ESP32
            # Không tính vào CG vì có thể tháo rời
